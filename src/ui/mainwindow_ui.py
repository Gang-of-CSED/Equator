...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.input1Label.setGeometry(QRect(20, 170, 101, 16))
        ...
        self.solutionErrorLabel_root.setGeometry(QRect(20, 130, 441, 31))
        font3 = QFont()
        font3.setPointSize(7)
        font3.setBold(True)
        self.solutionErrorLabel_root.setFont(font3)
        self.solutionErrorLabel_root.setWordWrap(True)
        ...
        self.noIterationsLineEdit = QLineEdit(self.tabRoot)
        self.noIterationsLineEdit.setObjectName(u"noIterationsLineEdit")
        self.noIterationsLineEdit.setGeometry(QRect(220, 250, 171, 21))
        self.noIterationsLineEdit.setReadOnly(True)
        self.noIterationsLabel = QLabel(self.tabRoot)
        self.noIterationsLabel.setObjectName(u"noIterationsLabel")
        self.noIterationsLabel.setGeometry(QRect(220, 220, 101, 16))
        self.noIterationsLabel.setFont(font2)
        self.equationLineEdit_2 = QLineEdit(self.tabRoot)
        self.equationLineEdit_2.setObjectName(u"equationLineEdit_2")
        self.equationLineEdit_2.setGeometry(QRect(20, 90, 351, 31))
        self.equationLabel_2 = QLabel(self.tabRoot)
        self.equationLabel_2.setObjectName(u"equationLabel_2")
        self.equationLabel_2.setGeometry(QRect(20, 70, 55, 16))
        self.equationLabel_2.setFont(font2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.equationLabel.setText(QCoreApplication.translate("MainWindow", u"f(X)", None))
        ...
        self.noIterationsLabel.setText(QCoreApplication.translate("MainWindow", u"No. iterations", None))
        self.equationLabel_2.setText(QCoreApplication.translate("MainWindow", u"g(x)", None))
